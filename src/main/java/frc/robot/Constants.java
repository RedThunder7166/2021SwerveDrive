...
public final class Constants {
    ...
    public static final class DriveConstants {
      ...
      public static final class ModuleConstants {
        ...
        public static final double kTurningPositiontoDegrees =360/ (2048*12.8);

    
        public static final int kTurningFalconEncoderCPR = 2048;
        public static final int kDriveCANcoderCPR = 4096;
